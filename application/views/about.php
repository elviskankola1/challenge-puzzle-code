		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Nous en quelques mots</h1>
				</header>
				<p> Lorem ipsum dolor sit amet, consectetur amagnam repudiandae sapiente.</p>
				<p>
					Nous Visons la Qualité de la Gestion Financière par la Qualité de la Formation Continue Numérique
					...
					* Sécuriser la traçabilité des comptes par l'usage du Bouclier numérique constitués des applications 
					informatiques appropriées et de logiciels indispensables.

					Cadres de Décision : le Conseil d'administration de la Société MASTER FORMATION qui définit les options
					décisionnelles et les modalités de la mise en œuvre des organes structurelles pour pallier aux attentes
					Cadres  d'exécution : le Corps Professoral et les Cadres vacataires de prestations de services financiers,
					comptables, informaticiens et dispensateurs de cours de langues, juristes ou pasteurs.
					Cadres de Participation : Tout Expertise Extérieure par jumelage des institutions ou par participation
					réciproque au terme des contrats d'assistance technique.
					Evaluation : Rapport Sanctionnant la Fin de Cycle de Formation sous un format homologué de très haute 
					qualité professionnelle: MASTER
				</p>
			...
			<aside class="col-sm-4 sidebar sidebar-right">
				...
				<div class="widget">
					<img src="assets/images/mac.jpg" alt="" class="img-rounded pull-right" width="100%" >
				</div>
