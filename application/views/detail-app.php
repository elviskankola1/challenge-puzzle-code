		...
		<div class="row">
			...
			<article class="col-md-8 maincontent">
				<header class="page-header">
					<h1 class="page-title"><?php echo $value->titre_app;?></h1>
				</header>
				 <p><?php echo $value->description_app;?></p>
			</article>
        </div><br><br><br><br><br><br><br><br><br><br>
        <?php endforeach?>
    </div>
    <?php else:?>
        <h1> Detail non trouver</h1><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    <?php endif?>
